...
const copyToClipboard = () : void => {
    ...
    alert("color copied to clipboard!"); // Alert the user that the color was copied
};
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8">
        ...
        <div className="grid gap-4">
            ...
            <div className="w-full h-48 rounded-lg border-4 border-gray-200 dark:border-gray-800"
